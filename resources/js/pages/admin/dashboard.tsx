        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-4 p-4 md:p-5">
                ...
                <section className="grid gap-3 lg:grid-cols-3">
                    <Link
                        href={admin.signals().url}
                        className="group flex flex-col gap-3 rounded-lg border border-slate-950/10 bg-white p-5 hover:border-slate-400"
                    >
                        ...
                        <span className="mt-auto inline-flex items-center gap-1 text-sm font-medium text-slate-950">
                            Open Signals
                            <ArrowRight className="size-4 shrink-0 group-hover:translate-x-0.5" />
                        </span>
                    </Link>
                ...
                <section className="rounded-lg border border-slate-950/10 bg-white p-5">
                    <div>
                    ...
                    >
                        <input
                            ...
                            className="w-full rounded-md px-3 py-2 text-sm ring-1 ring-slate-950/10 outline-none focus:ring-2 focus:ring-slate-950/20"
                        />
                        <button
                            type="submit"
                            className="shrink-0 rounded-lg bg-slate-950 py-2 pr-3 pl-3 text-sm font-medium text-white hover:bg-slate-800"
                        >
                            Search in Signals
                        </button>
                    </form>
                ...
                <section className="overflow-hidden rounded-lg border border-slate-950/10 bg-white">
                    <dl className="grid sm:grid-cols-2 xl:grid-cols-4">
                        {statItems.map(({ label, value }, i) => (
                            <div
                                key={label}
                                className={`px-5 py-4 ${statBorderClasses[i]}`}
                            >
                ...
                {recentActions.length > 0 ? (
                    <section className="rounded-lg border border-slate-950/10 bg-white p-5">
                        ...
                        <div className="mt-3 divide-y divide-slate-950/5">
